...
list_names = list.files(paste("C:/Users/Hannan Qazi/Documents/Sample Images",collapse = NULL,sep=''))

for (k in 1:length(list_names)){
  name = list_names[k]
  
  setwd = paste("C:/Users/Hannan Qazi/Documents/Sample Images/",name,sep = '')#Put directory of image folder of each set
  fileList=list.files(paste("C:/Users/Hannan Qazi/Documents/Sample Images/",name,sep = ''), recursive = TRUE) #Gives me the files names
...
#Create join
m = merge(df,stagelabels, by='id', all.x = TRUE)
...
write.csv(df,"C:/Users/Hannan Qazi/Desktop/train1.csv", row.names = FALSE)#Choose directory where to output .csv file with principal components
